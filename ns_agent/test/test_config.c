...
// const char buffer[] = "{\"json\":[{\"PATH\": \"/home/zhuzhicheng/project/glibc/version.h\",\"AUTHORITY\": \"r\"},{\"PATH\": \"/home/zhuzhicheng/project/cnpv/ns_agent/check.h\",\"AUTHORITY\": \"w\"},{\"PATH\": \"/home/zhuzhicheng/project/cnpv/ns_agent/check1.h\",\"AUTHORITY\": \"w\"}],\"test\":[{\"PATH\": \"/home/zhuzhicheng/project/glibc/version.h\",\"AUTHORITY\": \"r\"},{\"PATH\": \"/home/zhuzhicheng/project/cnpv/ns_agent/check.h\",\"AUTHORITY\": \"w\"}]}";
...
void config_init() {
  ...
  // json_t * root = json_loadb(buffer, sizeof(buffer), 0, NULL); 
  json_t * root = json_loadfd(fd, JSON_DECODE_ANY, NULL);

  log_info("json_loadfd() finish");
